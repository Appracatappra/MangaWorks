...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Appracatappra/SwiftUIKit.git", .upToNextMajor(from: "2.0.0")),
        .package(url: "https://github.com/Appracatappra/SpeechManager", .upToNextMajor(from: "2.0.0")),
        .package(url: "https://github.com/Appracatappra/SwiftUIGamepad.git", .upToNextMajor(from: "2.0.0")),
        .package(url: "https://github.com/Appracatappra/SwiftUIPanoramaViewer.git", .upToNextMajor(from: "2.0.0")),
        .package(url: "https://github.com/Appracatappra/ODRManager.git", .upToNextMajor(from: "2.0.0")),
    ],
    targets: [
